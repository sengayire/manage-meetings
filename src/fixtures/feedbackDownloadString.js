export const feedbackTemplateStyle = () => `
<style type="text/css">
  body {
...
export const feedbackListTemplate = response => `
...
export const feedbackHtmlTemplate = (feedback, formatedFeedback) => `<DOCTYPE html>
<html lang="en">
<head>
 <meta charset="UTF-8">
...
<div class="feedback-download">
  ...
  ${formatedFeedback.map(feedbackListTemplate).join('')}
  </div>
  </div>
  </div>
 </body>
...
export const feedbackSub = responses => `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <div class="feedback-sub-download">
    ${responses.map(feedbackListTemplate).join('')}
</div>
</body>
</html>`;
